...
from src.pydantic_models import MessageEntryPydantic, MessageExitPydantic
...
async def message_creation(req: Request, message: MessageEntryPydantic) -> MessageExitPydantic:
    res: MessageExitPydantic = await req.state.storage.message_storage.create_message(
