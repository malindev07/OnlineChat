from src.db_actions.actions_user_db import insert_user, show_all_users_from_db, search_user_db, authorization_db
from src.py_models.user_model import UserLogin, User
from src.pydantic_models import UserPydantic
from src.py_models.user_model import User as User_PY
...
class UsersStorage:
    ...
    #         return False
    @staticmethod
    async def show_all_users() -> list[User_PY]:
    ...
    @staticmethod
    async def search_user(user: UserLogin) -> bool | None:
